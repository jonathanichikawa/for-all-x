...
\begin{proof}
	\have[m]{a}{\metaA{}\substitute{x}{c^\ast}}
...
Here is a hint if you're interested in undertaking that project: the tree method encodes the same kind of reasoning that reductio proofs do.

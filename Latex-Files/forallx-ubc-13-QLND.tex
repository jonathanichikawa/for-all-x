...
\begin{proof}
	...
	\open	
		\hypo[n]{b}{\metaA{}\substitute{x}{c^\ast}} \by{for $\exists${}E}{}
		\hypo[p]{c}{\metaB{}}
	\close
...
\begin{proof}
	...
	\open
		...
		\hypo{st}{Sa \eif Ta}\Ae{ast}
		\hypo{t}{Ta} \ce{s,st}
		\hypo{et1}{\exists x Tx}\Ei{t}
	\close
...
\begin{proof}
	...
	\open
		\have{Ena}{\exists \script{x}\enot \metaA{}}\by{for reductio}{}
		\open
			\have{nc}{\enot \metaA{\substitute{\script{x}}{\script{a}^\ast}}}\by{for $\exists$E}{}
			\open
				\hypo{Aa2}{\forall \script{x} \metaA{}}\by{for reductio}{}
				\hypo{c2}{\metaA{\substitute{\script{x}}{\script{a}^\ast}}}\Ae{Aa}
				\hypo{nc2}{\enot \metaA{\substitute{\script{x}}{\script{a}^\ast}}}\by{R}{nc}
			\close
			\hypo{nAa}{\enot\forall \script{x} \metaA{}}\ni{Aa2-nc2}
		\close
		\hypo{nAa3}{\enot\forall \script{x} \metaA{}}\Ee{Ena, nc-nAa}
		\hypo{Aa3}{\forall \script{x} \metaA{}}\by{R}{Aa}
		\close
...
\begin{proof}
	\have{Aa}{\forall y Ay} \by{want $\enot\exists y\enot Ay$}{}
	\open
		\have{Ena}{\exists y\enot Ay}\by{for reductio}{}
		\open
			\have{nc}{\enot Ac}\by{for $\exists$E}{}
			\open
				\hypo{Aa2}{\forall y Ay}\by{for reductio}{}
				\hypo{c2}{Ac}\Ae{Aa}
				\hypo{nc2}{\enot Ac}\by{R}{nc}
			\close
			\hypo{nAa}{\enot\forall y Ay}\ni{Aa2-nc2}
		\close
		\hypo{nAa3}{\enot\forall y Ay}\Ee{Ena, nc-nAa}
		\hypo{Aa3}{\forall y Ay}\by{R}{Aa}
	\close
...
%	\open
%		\hypo{be1}{Be}
%		\hypo{all1}{\forall y\ e{=}y}\Ae{one}
%		\hypo{ef1}{e{=}f}\Ae{all1}
%		\hypo{bf1}{Bf}\by{{=}E}{ef1,be1}
%	\close
...
\begin{proof}
	\open
		...
		\hypo{p2}{\enot \exists x Mx \eand \enot \forall x\enot Mx}{}
		\hypo{p3}{\enot \exists x Mx}{}
		\hypo{p4}{\forall x\enot Mx}{}
		\hypo{p5}{\enot \forall x\enot Mx}{}
	\close

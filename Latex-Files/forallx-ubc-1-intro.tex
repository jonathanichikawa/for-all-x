...
But remember, validity has a very specific definition. It's not about whether arguments are good in any intuitive sense; it's about whether they satisfy the definition of validity. An argument is valid if and only if it is impossible for all the premises to be true while the conclusion is false. An in fact, the very point we just observed that seems to make this argument rather stupid --- the fact that its premises couldn't possibly be true together --- is exactly why this argument \emph{is} in fact valid. It's impossible for the premises to be true while the conclusion is false, because it's impossible for the premises to be true \emph{whether or not} the conclusion is false.

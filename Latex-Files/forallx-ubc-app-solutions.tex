...
\hypo{2}{L \eor \enot O}
\open
	\have{a1}{\enot L} \by{for reductio}{}
	\have{a2}{\enot O}\oe{2,a1}
	\have{a3}{L}\be{1,a2}
	\hypo{a4}{\enot L}\by{R}{a1}
\close
\have{3}{L}\ne{a1-a3, a1-a4}
\end{proof}
...
\open
	\have{a1}{\enot(N \eor  C)} \by{for reductio}{}
	\have{a2}{\enot N \eand \enot C} \by{DeM}{a1}
	\open
		\have{b1}{Z} \by{for reductio}{}
		\have{b2}{C \eand \enot N}\ce{1,b1}
		\have{b3}{C}\ae{b2}
		\hypo{b4}{\enot C}\ae{a2}
	\close
	\have{a3}{\enot Z}\ni{b1-b3, b1-b4}
	\have{a4}{N \eand \enot C}\ce{2,a3}
	\have{a5}{N}\ae{a4}
	\hypo{a6}{\enot N}\ae{a2}
\close
\have{3}{N \eor C}\ne{a1-a5, a1-a6}
\end{proof}
...
\begin{proof}
	...
	\open
		\have{b1}{\enot X} \by{for reductio}{}
		\have{b2}{\enot X\eor \enot Y} \oi{b1}
		\have{b3}{\enot (X \eand Y)} \by{DeM}{b2}
		\have{b4}{X\eand Z} \oe{a1,b3}
		\have{b5}{X} \ae{b4}
		\hypo{b6}{\enot X} \by{R}{b1}
	\close
	\have{c}{X} \ne{b1-b5, b1-b6}
	\open
		\have{d1}{\enot M} \by{for reductio}{}
		\have{d2}{D} \oe{a3,d1}
		\have{d3}{X\eand D} \ai{c,d2}
		\hypo{d4}{\enot(X\eand D)} \by{R}{a2}
	\close
	\have{e}{M} \ne{d1-d3, d1-d4}
\end{proof}
\end{solutioninlist}
...
\begin{proof}
	\open
		\have{nnon}{\enot (N \eor \enot N)}\by{for reductio}{}
		\have{nnnn}{\enot N \eand \enot\enot N}\by{DeM}{nnon}
		\have{n}{\enot N}\ae{nnnn}
		\hypo{nn}{\enot\enot N}\ae{nnnn}
	\close
...
\begin{proof}
	\open
		\have{panp}{P \eand \enot P}\by{for reductio}{}
		\have{p}{P}\ae{panp}
		\hypo{np}{\enot P}\ae{panp}
	\close
...
\begin{proof}
	\open
		\have{nainc}{\enot (A \eif \enot C)}\want{A \eif C}
		\open
			\have{a}{A}\want{C}{}
...
\open
		...
		\hypo{joblah}{J\eor (L\eand\enot L)}\oi{j}
	\close
	\have{jijblah}{J \eif [J\eor (L\eand\enot L)]}\ci{j-joblah}
	\open
		\have{jblah2}{J\eor (L\eand\enot L)}\want{J}
		\open
			\hypo{nj}{\enot J}\by{for reductio}{}
			\hypo{lanl}{L \eand \enot L}\oe{jblah2, nj}
			\hypo{l}{L}\ae{lanl}
			\hypo{nl}{\enot L}\ae{lanl}
		\close
		\hypo{j2}{J}\ne{nj-l,nj-nl}
	\close
...
\begin{proof}
	...
	\open
		...
		\hypo{4}{\enot \enot C}\by{MT}{2,3}
		\hypo{5}{C}\by{DN}{4}
		\hypo{6}{E \eand G}\ce{1,5}
		\hypo{7}{G}\ae{6}
		\hypo{8}{\enot G}\by{R}{3}
	\close
	\have{9}{G}\ne{3-7,3-8}
\end{proof}
\end{solutioninlist}
...
\begin{proof}
	...
	\open
		\hypo{6}{Y}\want{Z}
		\hypo{7}{Y \eand M}\ai{6,5}
		\hypo{8}{Z \eand K}\be{1,7}
		\hypo{9}{Z}\ae{8}
	\close
...
\begin{proof}
	...
	\open
		...
		\hypo{5}{\enot W \eand \enot Y}\by{DeM}{4}
		\hypo{6}{\enot Y}\ae{5}
		\hypo{7}{\enot W}\ae{5}
		\hypo{8}{\enot X}\by{MT}{2,6}
		\hypo{9}{\enot W \eand \enot X}\ai{7,8}
		\hypo{10}{\enot (W \eor X)}\by{DeM}{9}
		\hypo{11}{Y \eor Z}\oe{1,10}
		\hypo{12}{Z}\oe{11,6}
		\hypo{13}{\enot Z}\by{R}{3}
	\close
	\have{14}{W \eor Y}\ne{4-12,4-13}
\end{proof}
\end{solutioninlist}
...
\have{3}{\exists y(Rmy \eor Rym)}\Ae{p1}
	\open
		...
		\hypo{a2}{\enot Rma}\Ae{p2}
		\hypo{a3}{Ram}\oe{a1,a2}
		\hypo{a4}{\exists x Rxm}\Ei{a3}
	\close
...
\open
	...
	\hypo{d}{Ja}\Ae{c}
	\hypo{e}{Ja \eif Ka}\Ae{a}
	\hypo{f}{Ka}\ce{e,d}
	\hypo{3}{Laa}\Ae{2}
	\hypo{4}{Ka \eand Laa}\ai{f,3}
	\hypo{5}{\exists x(Kx \eand Lxx)}\Ei{4}
\close
...
\begin{proof}
	\open
		...
		\hypo{p2}{\enot \exists x Mx \eand \enot \forall x\enot Mx} \by{DeM}{p1}
		\hypo{p3}{\enot \exists x Mx}\ae{p2}
		\hypo{p4}{\forall x\enot Mx}\by{QN}{p3}
		\hypo{p5}{\enot \forall x\enot Mx}\ae{p2}
	\close
...
\begin{proof}
	\open
		...
		\hypo{s1}{\enot\forall x Fx \eand \enot\enot\forall x Fx} \by{DeM}{p1}
		\hypo{s2}{\enot \forall x Fx}\ae{s1}
		\hypo{s3}{\enot\enot\forall x Fx}\ae{s1}
	\close
...
\begin{proof}
	...
	\open
		\have{a2}{Ca \eor Dt} \by{for {$\exists$}E}{}
		\open
			\hypo{a3}{\enot(\exists x Cx \eor Dt)} \by{for reductio}{}
			\hypo{a4}{\enot\exists x Cx \eand \enot Dt} \by{DeM}{a3}
			\hypo{a5}{\enot Dt} \ae{a4}
			\hypo{a6}{Ca} \oe{a2,a5}
			\hypo{a7}{\exists x Cx} \Ei{a6}
			\hypo{a8}{\enot\exists x Cx} \ae{a4}
		\close
		\hypo{a9}{\exists x Cx \eor Dt} \ne{a3-a7, a3-a8}
	\close
...
\begin{proof}
	\open
		...
		\hypo{2}{\forall y Gay} \Ae{1}
		\hypo{3}{Gaa}\Ae{2}
		\hypo{4}{\exists x Gxx}\Ei{3}
\end{proof}
\end{solutioninlist}
...
\begin{proof}
	...
	\open
		...
		\hypo{a4}{Aa \eif Ba} \Ae{a1}
		\hypo{a5}{Ba} \ce{a3, a4}
		\hypo{a6}{\exists x Bx} \Ei{a5}
	\close
...
\begin{proof}
	...
	\open
		...
		\hypo{5}{\forall x (Mx \eiff Ma)} \ce{1, 4}
		\hypo{6}{Mb \eiff Ma} \Ae{5}
		\hypo{7}{Mb} \be{2, 6}
		\hypo{8}{\enot Mb} \by{R}{3}
	\close
	\have{9}{\enot Na} \ni{4-7, 4-8}
\end{proof}
\end{solutioninlist}
...
\open
	...
	\hypo{2}{Raa}\Ae{1}
	\hypo{3}{\exists y Ray}\Ei{2}
	\hypo{4}{\exists x \exists y Rxy}\Ei{3}
\close
...
\open
	...
	\open
		\have{c1}{\enot \exists x Lxx} \by{for reductio}{}
		...
		\open
			...
			\hypo{d2}{Lab} \by{R}{d1}
		\close
		\hypo{c5}{Lab \eif Lab} \ci{d1-d2}
		\hypo{c6}{\forall z(Laz \eif Laz)} \Ai{c5}
		\hypo{cn}{\enot \forall z(Laz \eif Laz)} \by{R}{c4}
	\close
	\have{h}{\exists x Lxx} \ne{c1-cn}
\close
...
\item %$\exists y\forall x Rxy$, \therefore\ $\forall x\exists y Rxy$
	...
	\begin{proof}
		...
		\open
			...
			\hypo{R}{Rba} \Ae{ass}
			\hypo{ER}{\exists y Rby} \Ei{R}
			\hypo{AER}{\forall x \exists y Rxy} \Ai{ER}
		\close

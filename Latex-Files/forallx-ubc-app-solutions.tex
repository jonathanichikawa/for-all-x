...
\solutionsection{ch.intro}{pr.Sentences1}
%\begin{earg}
...
\solutionsection{ch.SL}{pr.gregorbaseball}
\begin{ekey}
...
\solutionsection{ch.sl.trees}{pr.sl.treeroot}
\begin{earg}
...
\solutionsection{ch.sl.trees}{pr.sl.agtree}
...
\solutionsection{ch.sl.trees}{tree.examples}
\begin{earg}
...
\solutionsection{ch.SLsoundcomplete}{pr.SL.soundness-resolutions}
...
\solutionsection{ch.ND.proofs}{pr.justifySLproof}
...
\solutionsection{ch.ND.proofs}{pr.solvedSLproofs}
...
\solutionsection{ch.ND.proofs}{pr.SLND.theorems}
...
\begin{proof}
	\open
		\hypo{nnpanp}{\enot \enot (P \eand \enot P)}\by{for reductio}{}
		\have{panp}{P \eand \enot P}\by{DN}{nnpanp}
		\have{p}{P}\ae{panp}
		\have{np}{\enot P}\ae{panp}
	\close
	\have{npanp}{\enot (P \eand \enot P)}\ni{nnpanp-p,nnpanp-np}
\end{proof}
\end{solutioninlist}
...
\begin{proof}
	...
	\close
	\have{nainciaic}{\enot (A \eif \enot C) \eif (A \eif C) }\ci{o1-o2}
\end{proof}
\end{solutioninlist}
...
\solutionsection{ch.ND.proofs}{pr.solvedSLproofs2}
\begin{earg}
...
\solutionsection{ch.QL}{pr.QLbojacksome}
\begin{earg}
...
\solutionsection{ch.QL}{pr.QLdogtrans}
\begin{earg}
...
\solutionsection{ch.QL}{pr.QLpotluck}
\begin{earg}
...
\solutionsection{ch.QL}{pr.subinstanceQL}
\begin{earg}
...
\solutionsection{ch.QL.models}{pr.TorF1}
%\item $Bc$
\noSeq
...
\solutionsection{ch.QL.models}{pr.TorF2}
...
\solutionsection{ch.QL.models}{pr.TorF3}
\nextSeq%\item $Hc$
\noSeq%\item $He$
...
\solutionsection{ch.QL.models}{pr.InterpretationToModel}
\begin{partialmodel}
UD & \{10,11,12,13\}\\
\extension{O} & \{11,13\}\\
...
\solutionsection{ch.QL.models}{pr.Contingent}
\begin{earg}
\item %$Da \eand Db$
...
%
%
\solutionsection{ch.QL.models}{pr.NotEquiv}
...
\solutionsection{ch.QL.models}{pr.SemanticsEssay}
\begin{earg}
\stepcounter{eargnum}
...
\solutionsection{ch.QLTrees}{pr.QL.trees.tautology}
...
\solutionsection{ch.QLTrees}{pr.QL.trees.validity}
\begin{earg}
...
%\solutionsection{ch.QLTrees}{pr.QL.trees.translation.and.validity}
%\begin{earg}
%
%
%
...
\solutionsection{ch.QLsoundcomplete}{pr.QLalttrees-sound}
...
\solutionsection{ch.QLsoundcomplete}{pr.QLalttrees-complete}
...
\solutionsection{ch.identity}{pr.QL-ID-spies}
\begin{earg}
...
\solutionsection{ch.identity}{pr.QL-ID-cards}
\begin{earg}
...
\solutionsection{ch.identity}{pr.QLbuffy}
%\begin{ekey}
...
\solutionsection{ch.identity}{pr.IdentityModels}
\begin{earg}
...
\solutionsection{ch.identity}{pr.IdentityTrees}
...
\solutionsection{ch.QLND}{pr.justifyQLproof}
...
\solutionsection{ch.QLND}{pr.someQLproofs}
...
\solutionsection{ch.QLND}{pr.QLproofsNDe}
...
\begin{proof}
\open
	\hypo{1}{\enot \forall y\exists x(Qy \eif Qx)}\by{for reductio}{}
	\have{2}{\exists y \enot \exists x(Qy \eif Qx)}\by{QN}{1}
	\have{3}{\enot \exists x (Qa \eif Qx)}\Ee{2}
	\have{4}{\forall x\enot(Qa \eif Qx)}\by{QN}{3}
	\have{5}{\enot (Qa \eif Qa)}\Ae{4}
	\have{6}{\enot (\enot Qa \eor Qa)}\by{MC}{5}
	\have{7}{\enot \enot Qa \eand \enot Qa}\by{DeM}{6}
	\have{8}{\enot \enot Qa}\ae{7}
	\have{9}{\enot Qa}\ae{7}
\close
\have{10}{\forall y\exists x(Qy \eif Qx)}\ne{1-8,1-9}
\end{proof}
\end{solutioninlist}
\end{earg}
...
\solutionsection{ch.QLND}{pr.likes}
...
\solutionsection{ch.QLND}{pr.QLequivornot}
...
\solutionsection{ch.QLND}{pr.QLvalidornot}

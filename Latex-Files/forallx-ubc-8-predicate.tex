...
In QL, we will symbolize singular terms with lower-case letters $a$ through $w$. We can add numerical subscripts if we want to use some letter more than once. So $a,b,c,\ldots w, a_1, f_{32}, j_{390}$, and $m_{12}$ are all terms in QL.
...
\item[\ex{likes2}]There is someone who likes everyone who likes everyone that they like.
\end{earg}
...
with numerical subscripts, as needed & $a_1, w_4, h_7, m_{32},\ldots$\\
\hline
variables & $x,y,z$\\
with numerical subscripts, as needed & $x_1, y_1, z_1, x_2,\ldots$\\
\hline

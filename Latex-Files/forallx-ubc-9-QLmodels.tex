...
Suppose we want to show that $\forall xAxx \eif Bd$ is \emph{not} a tautology. In other words, we need to give a model where this sentence is false. What would such a model look like? In order for $\forall xAxx \eif Bd$ to be false, the antecedent ($\forall x Axx$) must be true, and the consequent ($Bd$) must be false.
...
\item If \metaA{} is $(\metaB{}\eand\metaC{})$ for some wffs \metaB{}, \metaC{}, then
\begin{displaymath}s(\metaA{}, a) =
	\left\{\begin{array}{ll}
...
\item If \metaA{} is $(\metaB{}\eor\metaC{})$ for some wffs \metaB{}, \metaC{}, then
\begin{displaymath}s(\metaA{}, a) =
	\left\{\begin{array}{ll}
...
\item If \metaA{} is $(\metaB{}\eif\metaC{})$ for some wffs \metaB{}, \metaC{}, then
\begin{displaymath}s(\metaA{}, a) =
	\left\{\begin{array}{ll}
...
\item If \metaA{} is $(\metaB{}\eiff\metaC{})$ for some wffs \metaB{}, \metaC{}, then
\begin{displaymath}s(\metaA{}, a) =
	\left\{\begin{array}{ll}
...
The same thing holds for any sentence of QL. Because all of the variables are bound, a sentence is satisfied or not regardless of the details of the variable assignment. So we can define truth in this way: A sentence \metaA{} is \define{true in} \model{M} if and only if some variable assignment satisfies \metaA{} in \model{M}; \metaA{} is \define{false in} \model{M} otherwise.
